...
public class UserDataLoader implements ApplicationRunner {
	...
	public void run(ApplicationArguments args) throws Exception {
		List<String[]> ayudantes = Arrays.asList(
				...
				new String[] { "ayudante2@caritas.com", "11111111", "1234", "Matias", "Lozano" },
		...
		List<String[]> usuarios = Arrays.asList(
				new String[] { "usuario1@caritas.com", "99999996", "1234", "Armando", "Testi", "1999-05-10" },
				new String[] { "usuario2@caritas.com", "99999995", "1234", "Jose", "Baneado", "1995-02-02" },
				...
				new String[] { "matilozano96@hotmail.com", "11111111", "1234", "Matias", "Lozano", "1996-02-02" });
